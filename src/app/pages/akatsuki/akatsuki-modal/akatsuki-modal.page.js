...
exports.AkatsukiModalPage = void 0;
const core_1 = require("@angular/core");
let AkatsukiModalPage = (() => {
    ...
    var AkatsukiModalPage = _classThis = class {
    ...
    __setFunctionName(_classThis, "AkatsukiModalPage");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _member_decorators = [(0, core_1.Input)()];
        ...
        AkatsukiModalPage = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AkatsukiModalPage = _classThis;
})();
exports.AkatsukiModalPage = AkatsukiModalPage;
