...
exports.AkatsukiPage = void 0;
const core_1 = require("@angular/core");
const akatsuki_modal_page_1 = require("./akatsuki-modal/akatsuki-modal.page");
let AkatsukiPage = (() => {
    ...
    let _classThis;
    var AkatsukiPage = _classThis = class {
        constructor(modalController) {
            this.modalController = modalController;
            this.akatsukiMembers = [
    ...
    __setFunctionName(_classThis, "AkatsukiPage");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        AkatsukiPage = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AkatsukiPage = _classThis;
})();
exports.AkatsukiPage = AkatsukiPage;
