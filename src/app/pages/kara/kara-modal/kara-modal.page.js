...
let KaraModalPage = (() => {
    ...
    var KaraModalPage = _classThis = class {
    ...
    __setFunctionName(_classThis, "KaraModalPage");
    (() => {
        ...
        KaraModalPage = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return KaraModalPage = _classThis;
})();
exports.KaraModalPage = KaraModalPage;
