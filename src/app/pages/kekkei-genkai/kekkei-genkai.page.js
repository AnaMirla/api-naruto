...
exports.KekkeiGenkaiPage = void 0;
const core_1 = require("@angular/core");
const kekkei_genkai_modal_page_1 = require("./kekkei-genkai-modal/kekkei-genkai-modal.page");
let KekkeiGenkaiPage = (() => {
    ...
    let _classThis;
    var KekkeiGenkaiPage = _classThis = class {
        constructor(modalController) {
            this.modalController = modalController;
            this.kekkeiGenkaiList = [
                {
                    name: 'Sharingan',
    ...
    __setFunctionName(_classThis, "KekkeiGenkaiPage");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        KekkeiGenkaiPage = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return KekkeiGenkaiPage = _classThis;
})();
exports.KekkeiGenkaiPage = KekkeiGenkaiPage;
