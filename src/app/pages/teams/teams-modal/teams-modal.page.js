...
let TeamsModalPage = (() => {
    ...
    var TeamsModalPage = _classThis = class {
        constructor(modalController) {
            this.modalController = modalController;
            this.team = __runInitializers(this, _team_initializers, void 0);
    ...
    __setFunctionName(_classThis, "TeamsModalPage");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _team_decorators = [(0, core_1.Input)()];
        ...
        TeamsModalPage = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TeamsModalPage = _classThis;
})();
exports.TeamsModalPage = TeamsModalPage;
